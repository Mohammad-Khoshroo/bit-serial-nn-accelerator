...
module Axi4_input_weight_brams_v1_0 #
	(
		...
		parameter integer C_S00_AXI_ADDR_WIDTH	= $clog2(BLOCK_NUM * BLOCK_SIZE),
	...
	output wire [ MAX_PES * WEIGHT_DATA_WIDTH - 1 : 0] weight_data,

	output wire [INPUT_DATA_WIDTH - 1 : 0] input_data,
	...
	input wire  s00_axi_aresetn,
		...
		Axi4_input_weight_brams_v1_0_S00_AXI # ( 
		.BLOCK_NUM (BLOCK_NUM ),
		...
		) Axi4_weight_brams_v1_0_S00_AXI_inst (
